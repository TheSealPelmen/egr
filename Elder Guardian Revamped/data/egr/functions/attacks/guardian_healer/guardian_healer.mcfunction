...
execute as @s[scores={egr_attack2_cd = 800..}] run function egr:attacks/guardian_healer/guardian_healer_attack
execute as @s if entity @e[tag=guardian_healer,distance=..19] run scoreboard players add @s guardian_healing 1
execute as @s[scores={egr_attack2_cd = ..0}] run scoreboard players set @s egr_attack2_cd 0
